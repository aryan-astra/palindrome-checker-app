...
Issue note: "bad2" is a placeholder issue request; this branch resolves it by explicitly tracking the request in documentation without changing application behavior.
